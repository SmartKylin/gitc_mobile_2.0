      ...
      >
        <div style={boxStyle}>
          ...
          <Field
            ...
            textArea={{ type: 'yes' }}
            rows="5"
            placeholder=" (在行业会议、论坛等的演讲、主持或荣誉简介)"
            model={speech_experience}
            changeValue={this.changeValue}
          ...
          <div className="zhuchangdingwei" style={{ padding: '13px' }}>
            ...
            >
              <span>选择你感兴趣的专场</span>
              <span style={{ color: '#2f72ff', marginLeft: '5px' }}>
                (选择1-2个)
              </span>
          ...
          >
            <div
              style={!this.state.posting ? btnStyle : btnStyle1}
              onClick={() => this.post()}
            >
              确定提交
            </div>
