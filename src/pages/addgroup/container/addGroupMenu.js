...
import '../index.scss';
import { getWeixinGroup } from '../../../services/home';
    ...
    return (
      <div className="AddGroupContainer-">
        ...
        >
                    ...
                    {item.data &&
                      ...
                      item.data.map((innerItem, index) => {
                        return index < 4 ? (
                          <div key={index}>
                            <img
                              style={{ width: '0.84rem', height: '0.84rem' }}
                              onClick={() => this.GroupPop(innerItem.img)}
                              src={innerItem.img}
                              alt=""
                            />
          ...
          {this.state.flag ? (
            <div className="AddGroupContainerBig">
              <img src={this.state.img} onClick={this.closePopImg} alt="" />
            </div>
          ) : (
            ''
          )}
