  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <div className="collection-item-time">11月23日</div>
          <div className="xian" />
          {guestData &&
            guestData[0] &&
            guestData[0].data.map((item, index) => (
              <CollectItem key={index} data={item} />
            ))}
          <div>
            <div className="collection-item-time">11月24日</div>
            <div className="xian" />
          </div>
          {guestData &&
            guestData[1] &&
            guestData[1].data.map((item, index) => (
              <CollectItem key={index} data={item} />
            ))}
        </div>
      </div>
