  ...
  render() {
    return (
     <div className="user">
       ...
       >
         <SubMenu key="sub1" title={<span><Icon type="file-text" style={{color: '#336cfa', fontSize: '17px'}}/><span>我的收藏</span></span>}>
           <Menu.Item key="1">
         ...
         <SubMenu key="sub2" title={<span><Icon type="file-add" style={{color: '#336cfa', fontSize: '17px'}}/><span>文档收藏</span></span>}>
