    ...
    return (
      <div>
        <div style={{display: 'flex', alignItems: 'center', position: 'absolute', width: '100%', zIndex: '100'}}>
          <a style={{width: '75px', height: '25px', background: '#263c66', lineHeight: '25px', textAlign: 'center', borderRadius: '12px', marginTop: '10px', fontSize: '11px', color: '#fff', position: 'relative', left: '66%'}} href={'https://www.bagevent.com/event/768490'}>立即购买</a>
