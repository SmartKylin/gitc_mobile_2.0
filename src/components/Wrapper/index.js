  ...
  render () {
    ...
    <div>    
      <div style={{display: 'flex', alignItems: 'center', position: 'relative', width: '100%', zIndex: '100', top: '20px', height: 0}}>
        <a style={{fontWeight:'800',width: '75px', height: '25px', lineHeight: '25px', textAlign: 'center', borderRadius: '12px', marginTop: '10px', fontSize: '11px', color: '#fff', position: 'relative', left: '65%'}} href={'https://www.bagevent.com/event/768490'} className={this.state.falg ? 'gradientA': 'gradient'} onClick={this.gradient}>立即购买</a>
