    ...
    return (
      <div className="loginbox">
        <div className="close--area">
          <div alt="" className="close--icon" onClick={this.closeLoginBox} />
        </div>
        <div className="form--wrap">
          ...
          <div className="code--area">
            <input
              ...
              onChange={() => this.setState({ code: this.code.value })}
            />
            {this.state.coding ? (
              <div className="send--code">重新发送{this.state.time}s</div>
            ) : (
              <div
                className={
                  'send--code ' + (this.state.mobileRight ? 'active' : '')
                }
          ...
          <div className="btn--area">
            <div className="btn--ensure" onClick={() => this.signIn()}>
              登录
            </div>
          </div>
        </div>
...
export default connect(state => ({ phone: state.phone }), { ...Actions })(
  LoginBox
);
