          ...
          <div className="ConferenceBox">
            <div className="ConferenceBoxShang">
              <div className="ConferenceBoxShangBox">
                ...
                <div className="ConferenceYw">{list.data.summary}</div>
                <div className="ConferenceTime">
                  <i
                    className="iconfont icon-shijian"
                    style={{ color: '#30508e', marginRight: '3px' }}
                  />时间: {list.time}
                </div>
                ...
                <div className="ConferenceContest">{list.data.content}</div>
              </div>
            </div>
          </div>
        ) : (
